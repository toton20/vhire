...
<head>
    ...
    <title>V-HIRE RESERVATION SYSTEM</title>
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-success">
              <div class="card-header"><span class="splash-description">Please Login.</span></div>
              <div class="card-body">
            ...
            <div class="splash-footer">&copy; 2022 - <?php echo date ('Y');?> V-Hire Reservation System </div>
          </div>
        </div>
      </div>
    </div>
