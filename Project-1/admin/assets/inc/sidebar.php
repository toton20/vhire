              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span><?php echo $row->admin_uname;?>'s Profile</span></a>
                    ...
                    <?php }?>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-car-estate"></i><span>V-Hire</span></a>
                  
                    <ul class="sub-menu">
                       <li><a href="emp-add-train.php">Add V-Hire</a>
                       <li><a href="emp-manage-train.php">Manage V-Hire</a>
                    </li>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi  mdi-account-check"></i><span>Drivers</span></a>
                    <ul class="sub-menu">
                      <li><a href="admin-add-employee.php">Add Drivers</a>
                      </li>
                      <li><a href="admin-manage-employee.php">Manage Drivers</a>
                      </li>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi  mdi-cash-multiple"></i><span>Accounting</span></a>
                    <ul class="sub-menu">
