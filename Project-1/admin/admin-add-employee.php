  ...
  <body>
	...
	<!--Log on to codeastro.com for more projects!-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Add Drivers</h2>
          ...
          <div class="row">
			...
			<!--Log on to codeastro.com for more projects!-->
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Create Drivers Profile<span class="card-subtitle">Fill All Details</span></div>
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">License Number</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Add New Drivers " name = "Create_Profile" type="submit">
