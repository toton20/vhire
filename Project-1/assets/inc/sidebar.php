              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-car-estate"></i><span>V-Hire</span></a>
                    ...
                    <ul class="sub-menu">
                       <li><a href="pass-all-available-trains.php">All Available V-Hire</a>
                       <li><a href="pass-search-available-trains.php">Search V-Hire</a>
                    </li>
                      
                    </ul>
                
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-briefcase-edit-outline"></i><span>Book V-Hire</span></a>
                    <ul class="sub-menu">
                      <li><a href="pass-book-train.php">Reserve V-Hire</a>
                      </li>
                      <li><a href="pass-cancel-train.php">Cancel V-Hire</a>
                      </li>
